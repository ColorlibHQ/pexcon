    ...
    <div class="col-full">
        <div class="featured">
            ...
            <div class="featured__column featured__column--big">
                <?php 
                $term = pexcon_opt( 'pexcon_featured_cat' );
                ...
                ?>
                    <div class="entry" <?php echo pexcon_inline_bg_img( get_the_post_thumbnail_url() ); ?>>
                        
                        <div class="entry__content">
                            <?php 
                            if( pexcon_featured_post_cat() ){
                                echo '<span class="entry__category">'.pexcon_featured_post_cat().'</span>';
                            }
                            ?>
