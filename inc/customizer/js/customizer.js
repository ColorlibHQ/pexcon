(function( $ , api){
    ...
    api.section( 'pexcon_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'pexcon_about_section' , function( section ){
    ...
    api.section( 'pexcon_blog_section' , function( section ){
    ...
    api.section( 'pexcon_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-pexcon_contact_custom_formshortcode'),
                selector = $('#_customize-input-pexcon_contact_formshortcode');
    ...
    // General section
    api.section( 'pexcon_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#pexcon_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-pexcon_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-pexcon_preloader_color' );
            ...
            var $backtotop          = $( '#pexcon_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-pexcon_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-pexcon_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'pexcon_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#pexcon_footer_widget_toggle');
