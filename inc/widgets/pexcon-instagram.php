...
----------------------------------------*/
class pexcon_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('pexcon_instagram_photo',esc_html__('[ Pexcon ] Intagram Photo','pexcon'),array(
			'description' => esc_html__('Pexcon Instagram Photo Widget','pexcon'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'pexcon');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'pexcon'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'pexcon'); ?></label>
...
if(!function_exists('pexcon_instagram_widgets')):
	function pexcon_instagram_widgets(){
		register_widget('pexcon_instagram_photo');
	}
	add_action('widgets_init','pexcon_instagram_widgets');
endif;
