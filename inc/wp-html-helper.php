...
// image default alt
if( !function_exists( 'pexcon_img_default_alt' ) ){
	function pexcon_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'pexcon_img_tag' ) ){
	function pexcon_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = pexcon_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'pexcon_anchor_tag' ) ){
	function pexcon_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'pexcon_heading_tag' ) ){
	function pexcon_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'pexcon_paragraph_tag' ) ){
	function pexcon_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'pexcon_other_tag' ) ){
	function pexcon_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'pexcon_button_element ' ) ){
	function pexcon_button_element( array $args ){
